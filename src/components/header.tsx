...
export default function Header() {
    ...
    // Cek login status hanya setelah component mounted
                            ...
                            <li>
                                <div suppressHydrationWarning>
                                    {mounted ? (
                                        ...
                                        // Loading skeleton untuk navigation
                                        <div className="animate-pulse bg-gray-300/30 h-14 rounded-xl"></div>
                                    )}
                                </div>
                            </li>
                            <li>
                            ...
                            {mounted ? (
                                user && isUserLoggedIn ? (
                                    ...
                                    <div className="space-y-3">
                                        <Link
                                            href="/login"
                                            className="w-full flex items-center justify-center p-4 bg-blue-500/80 hover:bg-blue-600/90 text-white rounded-xl transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50 backdrop-blur-sm border border-blue-400/20 shadow-md"
                                            onClick={closeDrawer}
                                        >
                                            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                // Loading state - tampilkan skeleton atau loading spinner
                                <div className="space-y-3">
                                    <div className="animate-pulse bg-gray-300/50 h-16 rounded-xl"></div>
                                    <div className="animate-pulse bg-gray-300/50 h-12 rounded-xl"></div>
                                </div>
                            )}
                        </div>
                    </div>
